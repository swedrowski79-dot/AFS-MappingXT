...
# PHP-FPM configuration templates (will be generated by entrypoint)
# Keep original files as templates for reference
...
# Use entrypoint to configure PHP settings from environment variables
